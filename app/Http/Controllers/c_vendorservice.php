...
class c_vendorservice extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.service.index')->with('success', 'Layanan berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('vendor.service.index')->with('success', 'Layanan berhasil diupdate.');
    }
